<script defer>
	...
	onMount(() => {
		...
		const cssResets = [
			...
			{
				name: 'HTML5 Doctor',
				link: 'https://raw.githack.com/richclark/HTML5resetCSS/master/reset.css'
			},
			{
				name: 'minireset.css',
				link: 'https://raw.githack.com/jgthms/minireset.css/master/minireset.min.css'
			},
			{ name: 'normalize.css', link: 'https://unpkg.com/normalize.css@8.0.1/normalize.css' },
			{
				name: 'Reboot',
				link: 'https://cdn.jsdelivr.net/npm/bootstrap-reboot@4.3.1/dist/reboot.min.css'
			},
			{ name: 'Remedy', link: 'https://raw.githack.com/mozdevs/cssremedy/master/remedy.css' },
			{
				name: 'sanitize.css',
				link: 'https://cdnjs.cloudflare.com/ajax/libs/10up-sanitize.css/10.0.0/sanitize.css'
			},
			{ name: 'UndoHTML', link: 'https://tantek.com/log/2004/undohtml.css' },
			{
				name: 'universalize.css',
				link: 'https://raw.githack.com/alexandersandberg/universalize.css/master/dist/universalize.min.css'
			}
		];
		...
		const cssFrameworks = [
			{
				name: 'awsm.css',
				link: 'https://raw.githack.com/igoradamenko/awsm.css/master/dist/awsm.min.css'
			},
			...
			{
				name: 'Foundation',
				link: 'https://cdnjs.cloudflare.com/ajax/libs/foundation/6.5.3/css/foundation.min.css'
			},
			...
			{
				name: 'Tacit',
				link: 'https://cdn.jsdelivr.net/gh/yegor256/tacit@gh-pages/tacit-css-1.5.0.min.css'
			},
			{
				name: 'Tufte',
				link: 'https://raw.githack.com/edwardtufte/tufte-css/gh-pages/tufte.min.css'
			},
			{ name: 'Tailwind', link: 'https://unpkg.com/tailwindcss@^1.0/dist/tailwind.min.css' },
			{
				name: 'Water.css (light)',
				link: 'https://cdn.jsdelivr.net/gh/kognise/water.css@latest/dist/light.min.css'
			},
			{
				name: 'Water.css (dark)',
				link: 'https://cdn.jsdelivr.net/gh/kognise/water.css@latest/dist/dark.min.css'
			},
			{ name: 'Writ', link: 'https://writ.cmcenroe.me/writ.min.css' },
			{ name: 'Sakura', link: 'https://cdn.jsdelivr.net/npm/sakura.css/css/sakura.css' }
		];
...
<main id="main">
    ...
    -->
		...
		<footer id="footer">
			<a href="#css-selection">Back to top 👆</a>
		</footer>
	</section>
	...
	<section id="grouping-content">
		...
		<article>
			...
			<address>
				...
				State: N/A<br />
				Planet: Mars<br />
				Digital home: <a href="">alexandersandberg.com</a><br />
			</address>
		</article>
...
exactly as written
		...
		<article>
			...
			<figure>
				...
				<figcaption>
					<cite>Naval Ravikant (@naval)</cite> on <a href="">Twitter</a>.
				</figcaption>
			</figure>
		</article>
...
&#125;</code
	...
	<section id="embedded-content">
		...
		<article>
			...
			<picture>
				<source srcset="https://dummyimage.com/1920x1080/000/fff" media="(min-width: 1200px)" />
				<img src="https://dummyimage.com/1920x1080/000/fff" alt="alt text" />
			</picture>
		</article>
		...
		<article>
			...
			<object title="object-title" data="./" type="application/pdf">
		...
		<article>
			...
			<img usemap="#image-map" src="https://dummyimage.com/1920x1080/000/fff" alt="alt text" />
		</article>
	...
	<section id="scripting">
		<header>
			<h2>Scripting</h2>
			<p>
				Elements: <code>&lt;script&gt;</code>, <code>&lt;noscript&gt;</code>,
				<code>&lt;template&gt;</code>, <code>&lt;canvas&gt;</code>
			</p>
		</header>
		...
		<article>
			...
			<p>
				Dynamic scripts and data blocks are included with the <code>&lt;script&gt;</code> element.
			</p>
			<script>
				// document.write('<p>This paragraph was generated with JavaScript!</p>');
			</script>
			<p>
				If scripting is disabled when loading the page, content inside <code>&lt;noscript&gt;</code>
				is used instead.
			</p>
			<noscript>
...
<footer>
	<p>
		<a href="">HTML5 elements tester</a> by <a href="">Alexander Sandberg</a> ·
		<a href="#css-selection">Back to top 👆</a>
	</p>
</footer>
